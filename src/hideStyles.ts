...
/** CSS variable for folder directory card color (set on body; defined in styles.css). */
const FOLDER_DIRECTORY_COLOR_VAR = "--graphforge-folder-directory-color";
...
/**
 * Apply dynamic CSS (folder directory color). Hide rules and layout live in styles.css.
